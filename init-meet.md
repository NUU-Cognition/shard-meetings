...
4. **Summaries follow the template.** Use `tmp-meet-summary` to produce consistent, structured output.
...
3. Agent runs `wkfl-meet-process` to process the meeting

## Skills

| Skill | File | Purpose |
|-------|------|---------|
| Clean | `sk-meet-clean.md` | Strip transcript artifacts (timestamps, speaker tags, filler) |
| Correct | `sk-meet-correct.md` | Context-aware transcription correction using Flint knowledge |

## Workflows

| Workflow | File | Purpose |
|----------|------|---------|
| Process Meeting | `wkfl-meet-process.md` | Full pipeline: rename to Raw, clean, optional addons, summarize |

## Templates

| Template | File | Purpose |
|----------|------|---------|
| Summary | `tmp-meet-summary-v0.1.md` | Structured meeting summary |
| Raw | `tmp-meet-raw-v0.1.md` | Raw transcript derivative |
| Cleaned | `tmp-meet-cleaned-v0.1.md` | Cleaned/corrected transcript derivative |
